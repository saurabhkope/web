				...
				?>
					...
					<html>
						<head>
							...
							<link rel="stylesheet" href="css/bootstrap.min.css?v=<?=$versionweb?>"/>
							<script src="js/jquery2.js?v=<?=$versionweb?>"></script>
							<script src="js/bootstrap.min.js?v=<?=$versionweb?>"></script>
							<script src="main.js?v=<?=$versionweb?>"></script>
							<style>
